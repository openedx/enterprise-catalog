...
from enterprise_catalog.apps.catalog.constants import PERMISSION_HAS_CATALOG_PROVISIONING_ADMIN_ACCESS
...
class EnterpriseCatalogCRUDViewSet(BaseViewSet, viewsets.ModelViewSet):
    ...
    def check_permissions(self, request):
        ...
        is_provisioning_admin = self.request.user.has_perm(PERMISSION_HAS_CATALOG_PROVISIONING_ADMIN_ACCESS)
