...
router.register(r'enterprise-catalog', views.EnterpriseCatalogCRUDViewSet, basename='enterprise-catalog')
router.register(r'enterprise-catalog', views.EnterpriseCatalogActionViewSet, basename='enterprise-catalog')
