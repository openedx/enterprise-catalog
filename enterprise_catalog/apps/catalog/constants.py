...
ENTERPRISE_CATALOG_PROVISIONING_ADMIN_ROLE = 'enterprise_catalog_provisioning_admin_role'
...
PERMISSION_HAS_CATALOG_PROVISIONING_ADMIN_ACCESS = 'provisioning.has_catalog_provisioning_admin_access'
