...
project = u'Enterprise catalog service'
...
man_pages = [
    ('index', 'Enterprise catalog service', u'Enterprise catalog service Documentation',
     [u'edX'], 1)
]
...
texinfo_documents = [
    ('index', 'Enterprise catalog service', u'Enterprise catalog service Documentation',
     u'edX', 'Enterprise catalog service', 'Enterprise catalog service',
     'Miscellaneous'
     ),
]
